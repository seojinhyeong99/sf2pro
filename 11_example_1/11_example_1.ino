...
#define _DUTY_MIN 5000 // servo full clockwise position (0 degree)
...
void loop() {
  ...
  // add your code here!
  float sx=(dist_raw-_TARGET_LOW)/(float)(_TARGET_HIGH-_TARGET_LOW)*(_DIST_MAX-_DIST_MIN);
  sx=sx*11.11;
  int ssx=sx+500;
  /*if(sx>=200){
